...
### GitHub Activity
No embedded activity cards here (GitHub image cards always route through `camo.githubusercontent.com` when clicked).

This README keeps the activity block clean and non-clickable.
